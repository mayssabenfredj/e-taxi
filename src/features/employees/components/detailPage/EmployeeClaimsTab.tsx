...
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from '@/shareds/components/ui/collapsible';
import { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationNext, PaginationPrevious } from '@/shareds/components/ui/pagination';
import { Search, Filter, MessageSquare, ChevronDown } from 'lucide-react';
import { Claim } from '@/features/employees/types/employee';
